...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitButton.addEventListener('click', function() {
        ...
        if (count === 4) {
            ...
            // send data to frontend summary sheet
            ...
            .then(response =>{
                if (response.ok){
                    console.log("summary saves successfully!");
                } else {
            ...
            proceedLink.href = '/dashboard/wk02/'; // Replace with the actual path to your new page
